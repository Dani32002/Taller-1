...
public class ConsolaOlimpicos
{
	...
	public void ejecutarPaisAtleta() {
		String nombre = input("Escriba el nombre del atleta que desea consultar.\n");
		Atleta elatleta = calculadora.buscarAtleta(nombre);
		System.out.println("El atleta es de: " + elatleta.darPais().darNombre() + "\n");
	}
